...
/**
 * Gold type subclass of Customer superclass
 *
 * <p>
...
public class Gold extends Customer {
    ...
    public Gold(String customerId, String customerName, String customerPassword) {
        super(customerId, customerName, customerPassword);
        this.discountRate = 0.15;
        this.concurrentRentals = 5;
        this.customerCredit = 0;
    }

    public Gold(String customerId, String customerName, String customerPassword, int customerCredit) {
